...
public class PacmanView implements ICommonMazeObjectView {
    ...
    public PacmanView(ImageView imageView, GridPane maze, int row, int col, double height, double width) {
